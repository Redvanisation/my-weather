            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                fetch(url).then(function (data) {
                    ...
                    switch (res.weather[0].main) {
                        case "Clear":
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/clearSky.mp4');
                            break;
                        case "Clouds":
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/coulds1.mp4');
                            break;
                        case "Few Clouds":
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/partlyCloudy/MP4/partlyCloudy.mp4');
                            break;
                        ...
                        case "Broken Clouds":
                            ...
                            break;
                        case "Rain":
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/rain/WEBM/rain.webm');
                            break;
                        case "Shower Rain":
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/rain/WEBM/rain.webm');
                            break;
                        case "Thunderstorm":
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/thunder.mp4');
                            break;
                        case "Snow":
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/snow/snow.mp4');
                            break;
                        case "Mist":
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/fog.mp4');
                            break;
                        default:
                            video.setAttribute('src', 'https://redvanisation.github.io/my-weather/videos/clearSky.mp4');
                            break;
